...
/// <summary>How much of the screen the logo is allowed to stand on.</summary>
public enum AreaChoice
{
    /// <summary>
    /// The desktop as far as the taskbar. A logo dragged to the bottom of the screen still
...
/// <summary>
/// Works out the rectangle the overlay covers. Unlike the cars, the logo is not attached
...
public static class DesktopArea
{
    ...
    public static AreaBounds Find(AreaChoice choice)
    {
        ...
        // second monitor instead of cutting the logo off at the edge of the first.
