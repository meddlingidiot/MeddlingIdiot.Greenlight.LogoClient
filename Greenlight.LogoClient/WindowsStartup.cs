...
/// <summary>
/// Whether the logo comes back when Windows does. One value under the current user's
...
/// <c>logo.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Logo";

    /// <summary>Whether Windows is currently set to start the logo.</summary>
    ...
    /// <summary>Ask Windows to start the logo, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.LogoClient\current\Greenlight.LogoClient.exe</c>,
