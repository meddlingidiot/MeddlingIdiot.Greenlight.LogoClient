...
/// of hit testing — clicks land on the logo instead of on the desktop underneath.
/// </remarks>
...
internal static class ClickThroughNative
{
    ...
    public static void Apply(IntPtr hwnd)
    {
        ...
        // uniform fade"; the logo's own translucency comes from the image and from how it is drawn.
    ...
    /// startup gets you a logo that is on top until the first time somebody clicks the
