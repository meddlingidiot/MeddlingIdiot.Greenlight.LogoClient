...
public class WindowsStartupTests
{
    ...
    {
        var running = @"C:\Users\jane\AppData\Local\Greenlight.LogoClient\current\Greenlight.LogoClient.exe";
        var shim = @"C:\Users\jane\AppData\Local\Greenlight.LogoClient\Greenlight.LogoClient.exe";
    ...
    public void A_folder_merely_called_current_is_not_a_promise()
    {
        ...
        var running = @"D:\stuff\current\Greenlight.LogoClient.exe";
    ...
    {
        var running = @"C:\src\logo\bin\Release\net10.0-windows\Greenlight.LogoClient.exe";
